...
When creating or proposing a commit message for reviewed changes, use an
imperative subject and include a detailed body explaining what changed and
why. Do not commit or push unless the user explicitly asks.
...
For this Java project, visual reviews should normally include the current
working-tree changes to `src/main/java` and any relevant project configuration
or documentation changes. The generated page is for review only; it does not
replace compiling or running the Java project.
